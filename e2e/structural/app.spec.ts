...
// - `label` no input de renomear categoria (`categoria-item.tsx`, atributo
//   `name="nome"`) -- sem label acessível, candidato a correção na Story
//   7.7 (migração de `/categorias`).
...
const GAPS_CONHECIDOS: GapConhecido[] = [
  ...
  { ruleId: 'label', htmlIncludes: 'name="nome"' },
